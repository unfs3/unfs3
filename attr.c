 ...
 */
static post_op_attr
get_post_ll(const char *path, uint32 dev, uint32 ino)
{
    struct stat buf;
    int res;
 ...
 */
post_op_attr
get_post_attr(const char *path, nfs_fh3 nfh)
{
